...
export const projects: Project[] = [
	{
		...
		detailedDescription: {
			ko: '웹 애플리케이션에서 발생할 수 있는 다양한 보안 취약점을 자동으로 탐지하고 분석하는 도구입니다. SQL Injection, XSS, CSRF 등의 주요 취약점을 식별하고 상세한 보고서를 제공합니다.',
	...
	},
	{
		...
		description: {
			ko: 'AWS 인프라의 보안 상태를 실시간으로 모니터링하는 시스템',
			en: 'Real-time monitoring system for AWS infrastructure security status',
		},
		detailedDescription: {
			ko: 'AWS 클라우드 환경의 보안 상태를 실시간으로 모니터링하고 이상 징후를 탐지하는 시스템입니다. CloudTrail, GuardDuty 등의 AWS 서비스와 연동하여 종합적인 보안 모니터링을 제공합니다.',
	...
	},
	{
		...
		description: {
			ko: '반응형 디자인과 다크모드를 지원하는 개인 포트폴리오',
			en: 'Personal portfolio with responsive design and dark mode support',
		},
		detailedDescription: {
			ko: '현재 보고 계신 포트폴리오 웹사이트입니다. React와 TypeScript로 구축되었으며, 반응형 디자인, 다크모드, 다국어 지원 등의 기능을 포함합니다.',
			en: 'This is the portfolio website you are currently viewing. Built with React and TypeScript, it includes features such as responsive design, dark mode, and multi-language support.',
		},
